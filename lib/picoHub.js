...
function requestTemp(clientId) {
  var buff = prepareMsg(clientId,{ jsonrpc: "2.0", id: _msgId, method: "temp/room", params: { }}, receiveTemp);
  _msgId++;
...
function requestLight(clientId) {
  var buff = prepareMsg(clientId,{ jsonrpc: "2.0", id: _msgId, method: "light/room", params: { }}, receiveLight);
  _msgId++;
