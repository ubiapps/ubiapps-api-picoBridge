(function () {
  ...
  var PicoBridgeService = function (rpcHandler, params) {
    ...
    this.base({
      ...
      displayName: "picosec://" + params.serviceId,
      description: params.serviceId,
  ...
  PicoBridgeService.prototype.setCurrent = function (params, successCB, errorCB) {
    return this._impl.setCurrent(params[0], successCB, errorCB);
  };
